...
STATUS: **FINAL APPROVED 아님 · Golden 미선언** — 아래 LOCKED 항목만 잠금, compare 장면은 REVIEW
...
| visual design | `engine/template.html` 현재 연출 (compare 장면 제외 → OPEN) |
...
- EP01 FINAL APPROVED → `EP01_GOLDEN_v1` 선언 (compare 해결 이후) (`shortform/golden/README.md`)
