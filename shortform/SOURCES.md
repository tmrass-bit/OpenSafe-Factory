...
| 구분 | 소스 | 라이선스 |
|---|---|---|
| 영상/그래픽 | 아래 실사 배경 5개를 제외한 전부 코드로 직접 제작 (HTML/CSS/SVG) | 자체 제작 |
...
| compare BEFORE 배경 사진 (약 18.27~18.82초, freeze) | Pexels · "A Woman Touching her Forehead" · 촬영 **Anna Tarazevich** · https://www.pexels.com/photo/a-woman-touching-her-forehead-6173659/ · 파일 `assets/stock/pexels-6173659-anna-tarazevich.jpg` (원본 3500×2333 → 머리·손 중심 1080×1920 세로 크롭) · 2026-09-25 다운로드 | Pexels License — 상업 이용·수정 가능, 출처 표기 불필요 |
| compare AFTER 배경 실사 영상 (약 18.82~19.9초) | Pexels · "Man Holding his Head" · 촬영 **Keira Burton** · https://www.pexels.com/video/man-holding-his-head-6623022/ · 파일 `assets/stock/pexels-6623022-keira-burton.mp4` (원본 2160×3840 10초 → 1080×1920 으로 축소 보관, 오디오 제거) · 8.8초~ 구간 사용 · 2026-09-25 다운로드 | Pexels License — 상업 이용·수정 가능, 출처 표기 불필요 |
...
- 금지 사항과 이 영상에서의 처리
  ...
  - compare BEFORE 사진(식별 가능한 인물): 이마를 짚고 생각하는 중립적 포즈(불쾌하거나 부정적으로 묘사되지 않음), 브랜드명·로고·추천 문구 없음
  - compare AFTER 클립(식별 가능한 인물): 차분히 앉아 있는 중립적 구간만 사용, 약한 블러·채도 감소 적용. 장면 안에 브랜드명·로고·추천 문구 없음 (라벨은 BEFORE/AFTER 설명 문구)
