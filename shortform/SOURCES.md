...
| 구분 | 소스 | 라이선스 |
|---|---|---|
| 영상/그래픽 | 아래 실사 배경 4개를 제외한 전부 코드로 직접 제작 (HTML/CSS/SVG) | 자체 제작 |
...
| compare 배경 실사 영상 (약 18.3~19.9초) | Pexels · "Man Holding his Head" · 촬영 **Keira Burton** · https://www.pexels.com/video/man-holding-his-head-6623022/ · 파일 `assets/stock/pexels-6623022-keira-burton.mp4` (원본 2160×3840 10초 → 1080×1920 으로 축소 보관, 오디오 제거) · BEFORE 3.5초~, AFTER 8.8초~ 구간 사용 (같은 카메라 · 매치 컷) · 2026-09-25 다운로드 | Pexels License — 상업 이용·수정 가능, 출처 표기 불필요 |
...
- 금지 사항과 이 영상에서의 처리
  ...
  - compare 클립(식별 가능한 인물): BEFORE 는 고개를 숙여 **얼굴이 보이지 않는** 구간만 사용, 얼굴이 보이는 AFTER 는 차분히 앉아 있는 중립적 구간만 사용. 약한 블러·채도 감소 적용. 장면 안에 브랜드명·로고·추천 문구 없음 (라벨은 BEFORE/AFTER 설명 문구)
